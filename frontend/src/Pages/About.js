...
function About() {
  return (
    <div>
      <h2>About Us</h2>
      <p>
        First, lets introduce the owner of Three Little Ladies Bakery, Lillian V. Tender.
        ...
        happy with her treats drove her to open Three Little Ladies Bakery in 2024 - named from her "three little nieces" who inspired her. Since
        then, Three Little Ladies Bakery has been a staple in the local community, known
        for its delicious cupcakes, cookies, cakes, and more.
      </p>
      <p>
        At Three Little Ladies Bakery, we believe in using only the finest ingredients to
        ...
        craving, Three Little Ladies Bakery is here to satisfy your dessert desires.
      </p>
      <p>
        Thank you for choosing Three Little Ladies Bakery, where every bite is a taste of
        happiness!
      </p>
